...
function	script	NPA	{
	...
	set .@Cost, 0; // Cash Points required
	...
	case 1:
		...
		if(getgmlevel() > 1) {
			mes "[Premium Account]";
			mes "ATTENTION! By going ahead";
			mes "from this point your GM Level";
			mes "will be reduced to 1";
...
//rent_mb,234,207,3	duplicate(StreetDealer)	Armor Dealer#ShArmor::ArmorrMid	99,4,4

rent_ma,125,64,5	duplicate(StreetDealer)	Premium Accounts#NPA::PremiumBal	864,4,4
rent_mb,125,64,5	duplicate(StreetDealer)	Premium Accounts#NPA::PremiumMid	864,4,4
